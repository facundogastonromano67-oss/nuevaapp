...
export const assessmentQuestions = [
  ...
  { id: 'planMode', section: 'Contrato del plan', text: '¿Qué versión del plan querés aceptar?', options: [option('normal', 'Normal · editable y sin penalizaciones'), option('hardcore', 'Hardcore · bloqueado y con penalizaciones por incumplir')] },
